...
p6 <- ggplot(data, aes(x=wl_grow, y=car_all)) +
        geom_smooth(method = "lm", se=TRUE, alpha = 0.4) +
  geom_point(aes(color = land_use), alpha = 0.8) +
  stat_cor(aes(label= ..rr.label..), digits = 2,  label.x = -0.15, label.y = 310) + 
  labs(color = "Land use",
...
p7 <- ggplot(data, aes(x=lat, y=car_all)) +
        geom_smooth(method = "lm", se=TRUE, alpha = 0.4) +
  geom_point(aes(color = land_use), alpha = 0.8) +
  stat_cor(aes(label= ..rr.label..), digits = 2,  label.x = 47, label.y = 310) + 
  labs(color = "Land use",
...
p8 <- ggplot(data, aes(x=sal_annual, y=car_all)) +
        geom_smooth(method = "lm", se=TRUE, alpha = 0.4) +
  geom_point(aes(color = land_use), alpha = 0.8) +
  stat_cor(aes(label= ..rr.label..), digits = 1,  label.x = 20, label.y = 310) + 
  labs(color = "Land use",
...
p9 <- ggplot(data_tidal, aes(x=dist_chan, y=car_all)) +
        geom_smooth(method = "lm", se=TRUE, alpha = 0.4) +
  geom_point(aes(color = land_use), alpha = 0.8) +
  stat_cor(aes(label= ..rr.label..), digits = 1,  label.x = 52, label.y = 315) + 
  labs(color = "Land use",
